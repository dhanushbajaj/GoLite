 ...
 * -------------------------------------------------------------
 */
GoLite_void bErrorPrint(GoLite_string fmt, ...);
GoLite_void displayBuffer(Buffer* ptr_Buffer);
GoLite_long getFileSize(GoLite_string fname);
GoLite_intg isNumber(const GoLite_string ns);
GoLite_void startReader(GoLite_string, GoLite_string, rune, GoLite_intg, GoLite_intg);
...
GoLite_intg mainReader(GoLite_intg argc, GoLite_string* argv) {

	/* Create source input buffer */
	GoLite_string program = argv[0];
	GoLite_string input = argv[2];
	rune mode = MODE_FIXED;
	GoLite_intg size = 0, increment = 0, wrongNumber = 0;
...
************************************************************
*/
GoLite_void startReader(GoLite_string program, GoLite_string input, rune mode, GoLite_intg size, GoLite_intg increment) {
